...
static void BM_ledger_iterate_accounts (benchmark::State & state)
{
	...
	auto ledger_impl{ std::make_unique<nano::ledger> (store, network_params, stats, logger, nano::ledger_options{ .generate_cache_flags = nano::generate_cache_flags::all_disabled () }) };
