...
enum class ext_ledger_flags : uint64_t
{
	...
	account_receivables_by_amount_initialized = 1 << 2,
};
...
private:
	...
	std::unique_ptr<nano::store::ext_ledger::account_receivables_by_amount_view> account_receivables_by_amount_impl;
...
public:
	...
	nano::store::ext_ledger::account_receivables_by_amount_view & account_receivables_by_amount;
