...
public:
	...
	void initialize_account_receivables_by_amount_index ();
	...
	void on_put_receivable (nano::store::write_transaction const &, nano::pending_key const &, nano::pending_info const &);
	void on_del_receivable (nano::store::write_transaction const &, nano::pending_key const &, nano::pending_info const &);
